    ...
    , public NServer::IDaemonBootstrap
{
    ...
    virtual NConcurrency::IThroughputThrottlerPtr CreateInThrottler(const std::string& bucket) = 0;
    virtual NConcurrency::IThroughputThrottlerPtr CreateOutThrottler(const std::string& bucket) = 0;
